...
rime_download_url="https://github.com/dreamer57/librime/releases/download/${rime_version}/${rime_archive}"
...
rime_deps_download_url="https://github.com/dreamer57/librime/releases/download/${rime_version}/${rime_deps_archive}"
